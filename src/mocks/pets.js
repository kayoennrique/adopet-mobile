...
const pets = [
    {
        ...
        description: {
            information: ['Se dá bem com outros animais', 'Se dá bem com crianças mais velhas mas se assusta com bebes', 'Gosta de brincar e passear'],
    ...
    },
    {
        ...
        description: {
            information: ['Se dá bem com outros gatos', 'Gosta de dormir e brincar'],
